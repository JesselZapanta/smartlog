...
export default function InstructorReportPrintPage() {
  const { user } = useAuth();
  ...
  useEffect(() => {
    ...
    api
      .get(`/instructor/reports?${params.toString()}`)
          ...
          <div className="space-y-6">
            ...
            <div className="mt-10 flex justify-end break-inside-avoid" style={{ breakInside: "avoid", pageBreakInside: "avoid" }}>
              <div className="w-[42%] text-[9px] sm:w-[36%] sm:text-xs" style={{ breakInside: "avoid", pageBreakInside: "avoid" }}>
                ...
                <p className="text-center text-[9px] text-gray-500 sm:text-[10px]">OJT Instructor</p>
              </div>
            </div>
