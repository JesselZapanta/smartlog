  ...
  return (
    <InstructorLayout>
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="font-heading text-2xl font-bold text-green-950 sm:text-3xl">Deployed Interns</h1>
          <p className="mt-1 text-sm text-gray-500">View interns currently deployed to their host establishments.</p>
        </div>
      </div>
