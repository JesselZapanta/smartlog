...
import { Users, Search, Eye, X, ArrowUp, ArrowDown, ChevronsUpDown,   Loader2 } from "lucide-react";
...
export default function CoordinatorInternListPage() {
  ...
  const loadRows = useCallback(async () => {
    ...
    try {
      ...
      const res = await api.get(`/registrations/interns?${params.toString()}`);
  ...
  return (
    <CoordinatorLayout>
            <PageHeader title="Interns" subtitle="View all approved interns in your institute." icon={Users} />
                    ...
                    >
                      ...
                      <TableCell>
                        <div className="flex items-center justify-end">
                          ...
                          >
                            <Link to={`/coordinator/interns/${intern.uuid}`} className="inline-flex items-center">
