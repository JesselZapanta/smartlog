...
const formFieldNames = ["institute_id", "name", "description", "type", "is_active"];
...
export default function RequirementFormDialog({ open, onOpenChange, requirement, institutes, onSaved }) {
  ...
  useEffect(() => {
    if (open) {
      form.reset(
        requirement
          ? {
              institute_id: String(requirement.institute_id || ""),
  ...
  async function onSubmit(values) {
    ...
    try {
      ...
      if (isEdit) {
        await api.put(`/requirements/${requirement.id}`, payload);
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div className="min-w-0">
              ...
              <DialogDescription className="text-sm">
                {isEdit
                  ? "Update the requirement details and status."
                  : "Create a new OJT requirement for an institute."}
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
