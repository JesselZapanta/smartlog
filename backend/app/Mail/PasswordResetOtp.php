...
class PasswordResetOtp extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        return new Envelope(
            ...
            subject: 'Your SMARTLOG password reset code',
        );
    }
    ...
    private function buildHtml(): string
    {
        ...
        <head>
            ...
            <title>Your SMARTLOG password reset code</title>
        ...
        <body style="margin:0;padding:0;background:#f9fafb;font-family:'Sora','DM Sans',Arial,Helvetica,sans-serif;color:#111827;-webkit-font-smoothing:antialiased;">
            <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;">
                Use the code {$this->code} to reset your SMARTLOG password. It expires in {$this->expiresInMinutes} minutes.
            </div>
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;">
                            ...
                            <tr>
                                <td style="background:#ffffff;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 20px 20px;padding:28px 28px 32px;">
                                    ...
                                    <div style="margin-top:6px;font-family:'Sora',Arial,sans-serif;font-size:22px;font-weight:700;color:#14532d;">Reset your password</div>
                                    <p style="margin:10px 0 0;font-size:14px;line-height:1.6;color:#4b5563;">
                                        Use the one-time passcode below to reset your SMARTLOG password. The code is valid for
                            ...
                            <tr>
                                <td style="padding:18px 16px 0;text-align:center;">
                                    <div style="font-size:11px;color:#9ca3af;line-height:1.7;">
                                        Tangub City Global College — OJT, Placement and Alumni Affairs Office<br>
