...
class InternDetailResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'hte' => $this->assignedHte ? [
                'name' => $this->assignedHte->name,
                'institute' => $this->assignedHte->institute?->name,
                'program' => $this->assignedHte->program?->name,
                'start_at' => $this->assignedHte->start_at,
                'end_at' => $this->assignedHte->end_at,
                'status' => $this->assignedHte->status,
            ] : null,
